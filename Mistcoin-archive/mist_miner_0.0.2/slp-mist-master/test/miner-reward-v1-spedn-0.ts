...
// // this is blockchain height
// let blockT0: number;
// let blockT1: number;
// const expectedT1Reward = parseInt(process.env.TOKEN_INIT_REWARD_V1 as string, 10);
// let blockT2: number;
// const expectedT2Reward = parseInt(process.env.TOKEN_INIT_REWARD_V1 as string, 10);

// const difficulty = 1;

// // this is token state height
// const stateT0TokenHeight = 0;  // .env contract has 0 hard-coded
...
//         blockT0 = (await rpcNodeMiner.getblockcount()) - 1;
//         blockT1 = blockT0 + 1;
//         blockT2 = blockT1 + 1;
//     });
...
//         const startingBlockHeight = encodeAsHex(blockT0);
...
//         unsignedMintHex = txnHelpers.setTxnLocktime(unsignedMintHex, blockT1);
...
//         // set nSequence to enable CLTV for all inputs, and set transaction Locktime
//         unsignedMintHex = txnHelpers.enableInputsCLTV(unsignedMintHex);
//         unsignedMintHex = txnHelpers.setTxnLocktime(unsignedMintHex, blockT2);
